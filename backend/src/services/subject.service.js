...
const getAllSubjects = async () => {
    ...
    const subjects =
        await subjectModel.getAllSubjects();
...
const getSubjectById = async (id) => {
    ...
    const subject =
        await subjectModel.findSubjectById(id);
...
const getSubjectByName = async (name) => {
    ...
    const subject =
        await subjectModel.findSubjectByName(name);
...
const createSubject = async (body) => {
    ...
    const existingSubject =
        await subjectModel.findSubjectByName(body.name);
    ...
    const subjectId =
        await subjectModel.createSubject(body);
